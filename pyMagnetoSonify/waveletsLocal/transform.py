...
def cwt(data, wavelet, scales, dt, axis):
...
class WaveletTransform(object):
    ...
    *oscillatory behaviour*.
    ...
    def __init__(self, data=None, time=None, dt=1,
                 ...
                 mask_coi=False, axis=-1,maxNumberSamples=1200):
        """Arguments:
        ...
        self.axis = axis
        self.maxNumberSamples = maxNumberSamples
    ...
    def compute_optimal_scales(self):
        ...
        maxNumberSamples = self.maxNumberSamples
        sj = generateCwtScales(maxNumberSamples, dj, dt, self.wavelet,self.N)
        return sj
